...
use CFileHelper as FileHelper;
use zazymko\swiftmailer\swift\Mailer;
use zazymko\swiftmailer\swift\Message;
...
class MessageTest extends TestCase
{
    ...
    {
        return __DIR__ . '/runtime/' . basename(get_class($this)) . '_' . getmypid();
    }
    ...
    {
        return Yii::app()->getComponent('mailer')->compose();
    }
